...
class _UiSettings(BaseSettings):
    ...
    title: str = "Wide Jump Predictive"
    logo: Optional[str] = None
    chat_logo: Optional[str] = None
    chat_title: str = "Project Assistant"
    chat_description: str = "This chatbot is configured to answer your project management questions"
...
class _BaseSettings(BaseSettings):
    ...
    auth_enabled: bool = Field(default=False, env="AUTH_ENABLED")  # Set to be configurable via environment
